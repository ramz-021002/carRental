    ...
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-8 order-md-1">
            ...
            <form class="needs-validation" action="input1.php" method="get/post">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="address" name="PickupLocation" placeholder="Picking Address" required="required">
                <div class="invalid-feedback">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="address2" name="DroppingLocation" placeholder="Dropping Address" required="required">
                <div class="invalid-feedback">
                    Please enter your Vechile picking address address.
                </div>
              </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                      ...
                      <select class="custom-select d-block w-100" id="state" name="State" required="required">
                        ...
                        <option value="Telangana">Karnataka</option>
                      </select>
                      <div class="invalid-feedback">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <div class="inpbox">
                    ...
                    <input class="form-control" id="p_date_time" type="datetime-local" placeholder="Pickup Date" name="Pickupdate" required="required">
                  </div>
                  <div class="invalid-feedback">
